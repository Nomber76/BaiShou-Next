  ...
  return (
    <div className="summary-dashboard">
      ...
      <div className="stats-grid">
        ...
        />
        <StatisticCard title={t('summary.stats_total_summaries')} value="48" subtitle="4 Types" />
        <StatisticCard title={t('summary.stats_streak')} value="15 Days" subtitle="Keep it up!" />
      </div>
    </div>
  )
}
